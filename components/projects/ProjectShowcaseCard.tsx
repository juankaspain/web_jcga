...
export function ProjectShowcaseCard({
  ...
  return (
    ...
    >
      {/* Single, fully clickable surface (better UX + fewer tab stops) */}
      <Link
        href={projectLink}
      ...
      >
        ...
        <div className="p-6">
          ...
          <h3 className="text-2xl font-bold mb-2 transition-colors duration-200 text-[var(--text-primary)] group-hover:text-[var(--accent-primary)]">
            {title}
          </h3>
          ...
          <div className="mt-6 inline-flex items-center gap-2 font-semibold transition-colors duration-200 text-[var(--accent-primary)] group-hover:text-[var(--accent-glow)]">
