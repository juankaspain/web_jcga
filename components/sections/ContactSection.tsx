  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-slate-900/50 py-24 lg:py-32">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 left-1/2 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-cyan-500/10 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <p className="mb-6 text-sm text-slate-500">{t.orConnect}</p>
          <div className="flex justify-center gap-4">
            {socialLinks.map((link) => (
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/50 text-slate-400 transition-all hover:border-cyan-500/50 hover:bg-slate-800 hover:text-cyan-400"
